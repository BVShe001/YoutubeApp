...
public class PlaylistAdapter extends RecyclerView.Adapter<PlaylistAdapter.PlaylistViewHolder> {
    ...
    public class PlaylistViewHolder extends RecyclerView.ViewHolder {
        ...
        void bind(PlaylistViewModel playlistViewModel,Integer position){
            binding.setVariable(com.example.android.youtubeapp.BR.viewModel,playlistViewModel);
            binding.setVariable(com.example.android.youtubeapp.BR.position,position);
